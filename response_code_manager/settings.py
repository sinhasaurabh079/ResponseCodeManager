"""
Django settings for response_code_manager project.
...
SECRET_KEY = 'django-insecure-1!c)9zxxxm1rriq)3$8(ao3w&!6$s&3)ks*p-tlu92j9*&%o2u'
...
WSGI_APPLICATION = 'response_code_manager.wsgi.application'
